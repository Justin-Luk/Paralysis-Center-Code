...
axs[0].set(title="3D Distance", xlabel="Frame", ylabel="X")
axs[1].set(title="Angle (0,4,8)", xlabel="Frame", ylabel="Y")
axs[2].set(title="TBD", xlabel="Frame", ylabel="Z")
...
while True:
    ...
    if key == ord('h'):
        ...
        print("Press 3 to calibrate closed hand position")
    ...
    if hands:
        ...
        #print(xx, yy, zz)
        special_sum= xx**2+yy**2+(zz)**2
        final_sum=special_sum** 1/2
        x_coordinates.append(final_sum)
        y_coordinates.append(angle)
        z_coordinates.append(c)
        frame_counter += 1
        axs[0].plot(range(frame_counter), x_coordinates)
        axs[1].plot(range(frame_counter), y_coordinates)
        #axs[2].plot(range(frame_counter), z_coordinates)
        plt.pause(0.01)
